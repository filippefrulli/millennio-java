...
public class singleplayerCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SP = getSharedPreferences("singleplayer", 0);
        ...
        backButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                startActivity(new Intent(singleplayerCategoryActivity.this, aMainActivity.class));
        ...
        historyButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                editor.apply();
                startActivity(new Intent(singleplayerCategoryActivity.this, singleplayerStartActivity.class));
                overridePendingTransition(0,0);
                finish();
            }
        });
