...
public class multiplayerStartp2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplayer_p2_start);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(multiplayerStartp2Activity.this, multiplayerGameActivity.class));
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                startActivity(new Intent(multiplayerStartp2Activity.this, aMainActivity.class));
                overridePendingTransition(0,0);
                finish();
            }
        });
